...
?>
<!-- SUNPEPE DEBUG template_file=<?php echo __FILE__; ?> plugin_dir=<?php echo SUNPEPE_PLUGIN_DIR; ?> plugin_url=<?php echo SUNPEPE_PLUGIN_URL; ?> page_template=<?php echo get_page_template_slug(); ?> -->
<!DOCTYPE html>
